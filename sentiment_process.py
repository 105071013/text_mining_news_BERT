...
##如果要更改QA模型，改以下路徑即可
qa_model_path = './model/all_topic_weights.h5'
...
class Sentiment_neg(object):
    ...
    def load(self, fname='./model/order_neg_sentiment.marshal', iszip=True):
...
class Sentiment_pos(object):
    ...
    def load(self, fname='./model/order_pos_sentiment.marshal', iszip=True):
        self.classifier.load(fname, iszip)
